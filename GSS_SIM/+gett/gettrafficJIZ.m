function [ data1k, data2k, data3k, JIZ1, JIZ2, JIZ3, hexa_c_ll_here ] = gettrafficJIZ( lat, lon, R, dt, map1, map2, map3, mapdata, netdata, hexa_c, hexas, V8 )
...
ifsees = sat.satsees( Recfsat, hexa_c_latlon, 45);
...
hexa_c_ll_here = hexa_c_latlon(ifsees,:);
