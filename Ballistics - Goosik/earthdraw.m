...
GMST0 = gstime (jd); % Set up a rotatable globe at J2000.0
...
if vw(2) == 90
 ...
 cla(H);
set(H, 'Color', space_color, 'Name', 'EARTH MOTHERFUCKA');
...
set(gca, 'XLim', [-9e+06 9e+06], 'YLim', [-7e+06 7e+06], 'ZLim', [-7e+06 7e+06]);
