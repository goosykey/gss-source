function [ STATE510, CART510, LATLON510 ] = seedconstel_bull( PRIMARY_STATE, jd, pla, spp )
...
%% PERFORMING BULLSHIT
bullshit = (1:NSAT)';
bullshit = mod(bullshit(:),spp) <= spp/2-1;

STATE510 = STATE510(bullshit,:);
CART510 = CART510(bullshit,:);
LATLON510 = LATLON510(bullshit,:);
