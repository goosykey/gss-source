function [ BIGASSMASK ] = intmaskone( map, mapdata, cdb, uidb )
%USAGE INTENSITY MASK INITIALIZATION (WITHOUT PARFOR)
%   20-05-2016
...
%   
%   WARNING: this version of INTMASK doesn't use parallel calculations thus
%       taking significantly longer to operate. Consider using
%       'intmasknew.m' instead.
